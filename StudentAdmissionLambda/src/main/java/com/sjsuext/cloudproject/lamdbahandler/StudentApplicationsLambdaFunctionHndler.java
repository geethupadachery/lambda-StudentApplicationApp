...
public class StudentApplicationsLambdaFunctionHndler implements RequestHandler<StudentAPIRequest, List<StudentDetails>> {
	...
	public static void main(String[] args) {
		StudentApplicationsLambdaFunctionHndler hndler = new StudentApplicationsLambdaFunctionHndler();
		StudentAPIRequest input = new StudentAPIRequest();
		input.setHttpMethod("GET");
		List<StudentDetails> handleRequest = hndler.handleRequest(input, null);
		
		for (StudentDetails studentDetails : handleRequest) {
